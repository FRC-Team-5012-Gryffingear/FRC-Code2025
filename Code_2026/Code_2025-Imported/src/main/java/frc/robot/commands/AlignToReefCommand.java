...
public class AlignToReefCommand extends Command {
    ...
    public AlignToReefCommand(
        ...
        this.xController = new PIDController(1.5, 0.0, 0.05);
        this.yController = new PIDController(1.5, 0.0, 0.05);
        this.rotController = new PIDController(0.56, 0.0, 0);
    ...
    public void execute() {
        ...
        double errorY = targetPose.getY() - robotPose.getY() - 2;
